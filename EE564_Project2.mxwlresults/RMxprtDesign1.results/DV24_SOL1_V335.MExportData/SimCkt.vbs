...
oEditor.CreatePagePort Array("NAME:PagePortProps", "Name:=", "C", "Id:=", 5), _
  ...
  "Degrees:=", 0, "Flip:=", false) 
oEditor.CreatePagePort Array("NAME:PagePortProps", "Name:=", "ROT1", "Id:=", 6), _
  Array("NAME:Attributes", "Page:=", 1, "X:=", 0.05842, "Y:=", -0.02794, _
  "Degrees:=", 180, "Flip:=", false) 
oEditor.CreatePagePort Array("NAME:PagePortProps", "Name:=", "ROT2", "Id:=", 7), _
  Array("NAME:Attributes", "Page:=", 1, "X:=", 0.05842, "Y:=", -0.03048, _
  "Degrees:=", 180, "Flip:=", false) 
oEditor.CreateComponent Array("NAME:ComponentProps", "Name:=", "V_ROT", "Id:=", _
  "8"), Array("NAME:Attributes", "Page:=", 1, "X:=", 0.09144, "Y:=", -0.0254, _
  "Degrees:=", 180, "Flip:=", false) 
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PassedParameterTab", _
  Array("NAME:PropServers", "CompInst@V_ROT;8;0"), Array("NAME:ChangedProps", _
...
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:Quantities", Array(_
  "NAME:PropServers", "CompInst@V_ROT;8;0"), Array("NAME:ChangedProps", _
  Array("NAME:VALUE", "OverridingDef:=", true, "Value:=", "1450rpm"))))
oEditor.CreatePagePort Array("NAME:PagePortProps", "Name:=", "ROT1", "Id:=", 9), _
  Array("NAME:Attributes", "Page:=", 1, "X:=", 0.08636, "Y:=", -0.02794, _
  "Degrees:=", 0, "Flip:=", false) 
oEditor.CreatePagePort Array("NAME:PagePortProps", "Name:=", "ROT2", "Id:=", _
  10), Array("NAME:Attributes", "Page:=", 1, "X:=", 0.08636, "Y:=", -0.0381, _
  "Degrees:=", 0, "Flip:=", false) 
...
oEditor.CreateComponent Array("NAME:ComponentProps", "Name:=", "AM", "Id:=", _
  "11"), Array("NAME:Attributes", "Page:=", 1, "X:=", 0.04318, "Y:=", 0.00762, _
  "Degrees:=", 90, "Flip:=", false) 
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PassedParameterTab", _
  Array("NAME:PropServers", "CompInst@AM;11;0"), Array("NAME:ChangedProps", _
  Array("NAME:InstanceName", "OverridingDef:=", true, "Value:=", "IA"))))
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PropDisplayPropTab", _
  Array("NAME:PropServers", "CompInst@AM;11;0"), Array("NAME:NewProps", _
  Array("NAME:InstanceName", "Format:=", "Value", "Location:=", "Right"))))
oEditor.CreateComponent Array("NAME:ComponentProps", "Name:=", "AM", "Id:=", _
  "12"), Array("NAME:Attributes", "Page:=", 1, "X:=", 0.04318, "Y:=", _
...
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PropDisplayPropTab", _
  ...
  Array("NAME:InstanceName", "Format:=", "Value", "Location:=", "Right"))))
oEditor.CreateComponent Array("NAME:ComponentProps", "Name:=", "AM", "Id:=", _
  "13"), Array("NAME:Attributes", "Page:=", 1, "X:=", 0.04318, "Y:=", -0.0127, _
  "Degrees:=", 90, "Flip:=", false) 
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PassedParameterTab", _
...
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PropDisplayPropTab", _
  ...
  Array("NAME:InstanceName", "Format:=", "Value", "Location:=", "Right"))))
oEditor.CreatePagePort Array("NAME:PagePortProps", "Name:=", "A", "Id:=", 14), _
  Array("NAME:Attributes", "Page:=", 1, "X:=", 0.04826, "Y:=", 0.01016, _
  "Degrees:=", 180, "Flip:=", false) 
oEditor.CreatePagePort Array("NAME:PagePortProps", "Name:=", "B", "Id:=", 15), _
  Array("NAME:Attributes", "Page:=", 1, "X:=", 0.04826, "Y:=", 0, "Degrees:=", _
  180, "Flip:=", false) 
oEditor.CreatePagePort Array("NAME:PagePortProps", "Name:=", "C", "Id:=", 16), _
  Array("NAME:Attributes", "Page:=", 1, "X:=", 0.04826, "Y:=", -0.01016, _
  "Degrees:=", 180, "Flip:=", false) 
...
oEditor.CreateComponent Array("NAME:ComponentProps", "Name:=", "E", "Id:=", _
  "17"), Array("NAME:Attributes", "Page:=", 1, "X:=", -0.00254, "Y:=", _
  -0.03048, "Degrees:=", 0, "Flip:=", false) 
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PropDisplayPropTab", _
  Array("NAME:PropServers", "CompInst@E;17;0"), Array("NAME:NewProps", Array(_
  "NAME:InstanceName", "Format:=", "Value", "Location:=", "Right"))))
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PassedParameterTab", _
  Array("NAME:PropServers", "CompInst@E;17;0"), Array("NAME:ChangedProps", _
  Array("NAME:InstanceName", "OverridingDef:=", true, "Value:=", "VA"))))
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PassedParameterTab", _
  Array("NAME:PropServers", "CompInst@E;17;0"), Array("NAME:ChangedProps", _
  Array("NAME:Type", "OverridingDef:=", true, "Value:=", "ESINE"))))
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:Quantities", Array(_
  "NAME:PropServers", "CompInst@E;17;0"), Array("NAME:ChangedProps", Array(_
...
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:Quantities", Array(_
  "NAME:PropServers", "CompInst@E;17;0"), Array("NAME:ChangedProps", Array(_
  "NAME:PHASE", "OverridingDef:=", true, "Value:=", "30deg"))))
oEditor.CreateWire Array("NAME:WireData", "Id:=", "1", "Points:=", Array(_
...
oEditor.CreateWire Array("NAME:WireData", "Id:=", "1", "Points:=", Array(_
  ...
  "Page:=", 1) 
oEditor.CreateComponent Array("NAME:ComponentProps", "Name:=", "E", "Id:=", _
  "18"), Array("NAME:Attributes", "Page:=", 1, "X:=", 0.01016, "Y:=", _
  -0.03048, "Degrees:=", 0, "Flip:=", false) 
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PropDisplayPropTab", _
  Array("NAME:PropServers", "CompInst@E;18;0"), Array("NAME:NewProps", Array(_
  "NAME:InstanceName", "Format:=", "Value", "Location:=", "Right"))))
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PassedParameterTab", _
  Array("NAME:PropServers", "CompInst@E;18;0"), Array("NAME:ChangedProps", _
  Array("NAME:InstanceName", "OverridingDef:=", true, "Value:=", "VB"))))
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PassedParameterTab", _
  Array("NAME:PropServers", "CompInst@E;18;0"), Array("NAME:ChangedProps", _
  Array("NAME:Type", "OverridingDef:=", true, "Value:=", "ESINE"))))
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:Quantities", Array(_
  "NAME:PropServers", "CompInst@E;18;0"), Array("NAME:ChangedProps", Array(_
  "NAME:AMPL", "OverridingDef:=", true, "Value:=", "179.629V"))))
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:Quantities", Array(_
  "NAME:PropServers", "CompInst@E;18;0"), Array("NAME:ChangedProps", Array(_
  "NAME:FREQ", "OverridingDef:=", true, "Value:=", "50Hz"))))
...
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:Quantities", Array(_
  "NAME:PropServers", "CompInst@E;18;0"), Array("NAME:ChangedProps", Array(_
  "NAME:PHASE", "OverridingDef:=", true, "Value:=", "270deg"))))
oEditor.CreateWire Array("NAME:WireData", "Id:=", "1", "Points:=", Array(_
...
oEditor.CreateWire Array("NAME:WireData", "Id:=", "1", "Points:=", Array(_
  ...
  "Page:=", 1) 
oEditor.CreateComponent Array("NAME:ComponentProps", "Name:=", "E", "Id:=", _
  "19"), Array("NAME:Attributes", "Page:=", 1, "X:=", 0.02286, "Y:=", _
  -0.03048, "Degrees:=", 0, "Flip:=", false) 
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PropDisplayPropTab", _
  Array("NAME:PropServers", "CompInst@E;19;0"), Array("NAME:NewProps", Array(_
  "NAME:InstanceName", "Format:=", "Value", "Location:=", "Right"))))
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PassedParameterTab", _
  Array("NAME:PropServers", "CompInst@E;19;0"), Array("NAME:ChangedProps", _
  Array("NAME:InstanceName", "OverridingDef:=", true, "Value:=", "VC"))))
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PassedParameterTab", _
  Array("NAME:PropServers", "CompInst@E;19;0"), Array("NAME:ChangedProps", _
  Array("NAME:Type", "OverridingDef:=", true, "Value:=", "ESINE"))))
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:Quantities", Array(_
  "NAME:PropServers", "CompInst@E;19;0"), Array("NAME:ChangedProps", Array(_
  "NAME:AMPL", "OverridingDef:=", true, "Value:=", "179.629V"))))
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:Quantities", Array(_
  "NAME:PropServers", "CompInst@E;19;0"), Array("NAME:ChangedProps", Array(_
  "NAME:FREQ", "OverridingDef:=", true, "Value:=", "50Hz"))))
...
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:Quantities", Array(_
  "NAME:PropServers", "CompInst@E;19;0"), Array("NAME:ChangedProps", Array(_
  "NAME:PHASE", "OverridingDef:=", true, "Value:=", "150deg"))))
oEditor.CreateWire Array("NAME:WireData", "Id:=", "1", "Points:=", Array(_
