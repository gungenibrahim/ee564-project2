...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Name:=", "DiaGap", "Value:=", "54.8625mm"), Array("NAME:Pair", "Name:=", _
  "DiaYoke", "Value:=", "18mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "380.5085642682907mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "DiaYoke", "Value:=", "90mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "300mm"), Array("NAME:Pair", "Name:=", "Skew", "Value:=", "0deg"), _
  ...
  "Value:=", "380.5085642682907mm"), Array("NAME:Pair", "Name:=", "InfoCore", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "380.5085642682907mm"), Array("NAME:Pair", "Name:=", "InfoCoil", "Value:=", _
...
oModule.AssignWindingGroup Array("NAME:PhaseA", "Type:=", "Voltage", _
  "IsSolid:=", false, "Current:=", "0A", "Resistance:=", "6.06717ohm", _
  "Inductance:=", "0H", "Voltage:=", "311.127 * sin(2*pi*50*time)", _
  "ParallelBranchesNum:=", "1")
Set oModule = oDesign.GetModule("BoundarySetup")
oModule.AssignWindingGroup Array("NAME:PhaseB", "Type:=", "Voltage", _
  "IsSolid:=", false, "Current:=", "0A", "Resistance:=", "6.06717ohm", _
  "Inductance:=", "0H", "Voltage:=", "311.127 * sin(2*pi*50*time-2*pi/3)", _
  "ParallelBranchesNum:=", "1")
Set oModule = oDesign.GetModule("BoundarySetup")
oModule.AssignWindingGroup Array("NAME:PhaseC", "Type:=", "Voltage", _
  "IsSolid:=", false, "Current:=", "0A", "Resistance:=", "6.06717ohm", _
  "Inductance:=", "0H", "Voltage:=", "311.127 * sin(2*pi*50*time-4*pi/3)", _
  "ParallelBranchesNum:=", "1")
oModule.AssignCoilTerminal Array("NAME:PhA_0", "Objects:=", Array("CoilTerm_0"), _
  "Conductor number:=", 20, "Point out of terminal:=", false, "Winding:=", _
  "PhaseA")
...
oModule.AssignCoilTerminal Array("NAME:PhCRe_3", "Objects:=", Array(_
  "CoilTerm_3"), "Conductor number:=", 20, "Point out of terminal:=", true, _
  "Winding:=", "PhaseC")
oModule.AssignCoilTerminal Array("NAME:PhCRe_4", "Objects:=", Array(_
  "CoilTerm_4"), "Conductor number:=", 20, "Point out of terminal:=", true, _
  "Winding:=", "PhaseC")
oModule.AssignCoilTerminal Array("NAME:PhCRe_5", "Objects:=", Array(_
  "CoilTerm_5"), "Conductor number:=", 20, "Point out of terminal:=", true, _
  "Winding:=", "PhaseC")
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "DiaYoke", "Value:=", "18mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "300mm"), Array("NAME:Pair", "Name:=", "Skew", "Value:=", _
  "12deg"), Array("NAME:Pair", "Name:=", "Slots", "Value:=", "30"), Array(_
  ...
  "Name:=", "LenRegion", "Value:=", "380.5085642682907mm"), Array("NAME:Pair", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  Array("NAME:Pair", "Name:=", "DiaGap", "Value:=", "54.725mm"), Array(_
  "NAME:Pair", "Name:=", "DiaYoke", "Value:=", "18mm"), Array("NAME:Pair", _
  "Name:=", "Length", "Value:=", "300mm"), Array("NAME:Pair", "Name:=", _
  "Skew", "Value:=", "12deg"), Array("NAME:Pair", "Name:=", "Slots", _
  "Value:=", "30"), Array("NAME:Pair", "Name:=", "SlotType", "Value:=", "1"), _
  Array("NAME:Pair", "Name:=", "Hs0", "Value:=", "0.544mm"), Array(_
  "NAME:Pair", "Name:=", "Hs01", "Value:=", "0mm"), Array("NAME:Pair", _
  "Name:=", "Hs1", "Value:=", "0mm"), Array("NAME:Pair", "Name:=", "Hs2", _
  "Value:=", "8.949999999999999mm"), Array("NAME:Pair", "Name:=", "Bs0", _
  "Value:=", "1.1mm"), Array("NAME:Pair", "Name:=", "Bs1", "Value:=", _
  "3.69mm"), Array("NAME:Pair", "Name:=", "Bs2", "Value:=", _
  "0.8080000000000001mm"), Array("NAME:Pair", "Name:=", "Rs", "Value:=", _
  "0mm"), Array("NAME:Pair", "Name:=", "FilletType", "Value:=", "0"), Array(_
  "NAME:Pair", "Name:=", "HalfSlot", "Value:=", "0"), Array("NAME:Pair", _
  "Name:=", "BarEndExt", "Value:=", "0.1mm"), Array("NAME:Pair", "Name:=", _
  "RingLength", "Value:=", "0.1mm"), Array("NAME:Pair", "Name:=", _
  "RingHeight", "Value:=", "0.1mm"), Array("NAME:Pair", "Name:=", _
  "RingDiaGap", "Value:=", "0mm"), Array("NAME:Pair", "Name:=", "CastRotor", _
  "Value:=", "1"), Array("NAME:Pair", "Name:=", "SegAngle", "Value:=", _
...
oModule.AssignLengthOp Array("NAME:Length_Main", "RefineInside:=", true, _
  ...
  "RestrictLength:=", true, "MaxLength:=", "14.11mm")
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "Moment of Inertia:=", 0.00206043, "Damping:=", 0.000477137, _
  "Load Torque:=", "if(speed<76.969, -0.000351306*speed, -2.08122/speed)", _
  "Objects:=", Array("Band"))
