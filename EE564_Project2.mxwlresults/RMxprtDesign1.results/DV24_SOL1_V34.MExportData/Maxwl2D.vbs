...
oDefinitionManager.ModifyLibraries designName, Array("NAME:PersonalLib"), _
  ...
  "Materials", "RMxprt"))
if (oDefinitionManager.DoesMaterialExist("steel_1008_2DSF0.950")) then
else
oDefinitionManager.AddMaterial Array("NAME:steel_1008_2DSF0.950", _
  ...
  "X:=", 159155, "Y:=", 2.176), Array("NAME:Coordinate", "X:=", 318310, "Y:=", _
  2.38075), Array("NAME:Coordinate", "X:=", 397887, "Y:=", 2.48084), Array(_
  "NAME:Coordinate", "X:=", 1.19366e+006, "Y:=", 3.48179))), "mass_density:=", _
  7872) 
end if
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "steel_1008_2DSF0.950", "SolveInside:=", true) 
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Value:=", "0mm"), Array("NAME:Pair", "Name:=", "FilletType", "Value:=", _
  "0"), Array("NAME:Pair", "Name:=", "HalfSlot", "Value:=", "0"), Array(_
  "NAME:Pair", "Name:=", "BarEndExt", "Value:=", "2mm"), Array("NAME:Pair", _
  "Name:=", "RingLength", "Value:=", "2mm"), Array("NAME:Pair", "Name:=", _
  "RingHeight", "Value:=", "2mm"), Array("NAME:Pair", "Name:=", "RingDiaGap", _
...
oModule.AssignEndConnection Array("NAME:EndConnection1", "Objects:=", Array(_
  ...
  "Bar_Separate13", "Bar_Separate14"), "ResistanceValue:=", "2.27562e-005ohm", _
  "InductanceValue:=", "1.#QNANH")
Set oModule = oDesign.GetModule("MeshSetup")
...
oModule.AssignTrueSurfOp Array("NAME:SurfApprox_Bar", "Objects:=", Array("Bar", _
  ...
  "0.0265mm", "NormalDevChoice:=", 2, "NormalDev:=", "15deg", _
  "AspectRatioChoice:=", 1)
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/SlotCore", "Version:=", "12.1", "NoOfParameters:=", 19, _
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
...
oModule.AssignLengthOp Array("NAME:Length_Main", "RefineInside:=", true, _
  ...
  "RestrictLength:=", true, "MaxLength:=", "3.7mm")
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
