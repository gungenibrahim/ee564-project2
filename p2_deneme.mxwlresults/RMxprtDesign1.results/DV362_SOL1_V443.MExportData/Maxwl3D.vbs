...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Value:=", "336.0615519071856mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "DiaYoke", "Value:=", "90mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "250mm"), Array("NAME:Pair", "Name:=", "Skew", "Value:=", "0deg"), _
  ...
  "Value:=", "336.0615519071856mm"), Array("NAME:Pair", "Name:=", "InfoCore", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "336.0615519071856mm"), Array("NAME:Pair", "Name:=", "InfoCoil", "Value:=", _
...
oModule.AssignWindingGroup Array("NAME:PhaseA", "Type:=", "Voltage", _
  "IsSolid:=", false, "Current:=", "0A", "Resistance:=", "20.4799ohm", _
...
oModule.AssignCoilTerminal Array("NAME:PhCRe_3", "Objects:=", Array(_
  "CoilTerm_3"), "Conductor number:=", 15, "Point out of terminal:=", true, _
  "Winding:=", "PhaseC")
oModule.AssignCoilTerminal Array("NAME:PhCRe_4", "Objects:=", Array(_
  "CoilTerm_4"), "Conductor number:=", 15, "Point out of terminal:=", true, _
  "Winding:=", "PhaseC")
oModule.AssignCoilTerminal Array("NAME:PhCRe_5", "Objects:=", Array(_
  "CoilTerm_5"), "Conductor number:=", 15, "Point out of terminal:=", true, _
  "Winding:=", "PhaseC")
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "DiaYoke", "Value:=", "18mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "250mm"), Array("NAME:Pair", "Name:=", "Skew", "Value:=", _
  ...
  "Name:=", "LenRegion", "Value:=", "336.0615519071856mm"), Array("NAME:Pair", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Name:=", "Length", "Value:=", "250mm"), Array("NAME:Pair", "Name:=", _
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "Consider Mechanical Transient:=", true, "Angular Velocity:=", "1440.51rpm", _
  "Moment of Inertia:=", 0.00171389, "Damping:=", 0.00143765, "Load Torque:=", _
  "if(speed<139.801, -0.056288*speed, -1100.11/speed)", "Objects:=", Array(_
  "Band"))
