...
oModule.AssignWindingGroup Array("NAME:PhaseA", "Type:=", "Voltage", _
  ...
  "Inductance:=", "0.000990567H", "Voltage:=", "310.269 * sin(2*pi*50*time)", _
  "ParallelBranchesNum:=", "1")
Set oModule = oDesign.GetModule("BoundarySetup")
oModule.AssignWindingGroup Array("NAME:PhaseB", "Type:=", "Voltage", _
  "IsSolid:=", false, "Current:=", "0A", "Resistance:=", "20.4799ohm", _
  "Inductance:=", "0.000990567H", "Voltage:=", _
...
oModule.AssignCoil Array("NAME:PhCRe_3", "Objects:=", Array("Coil_3"), _
  "Conductor number:=", 15, "PolarityType:=", "Negative", "Winding:=", _
  "PhaseC")
oModule.AssignCoil Array("NAME:PhC_3", "Objects:=", Array("CoilRe_12"), _
  "Conductor number:=", 15, "PolarityType:=", "Positive", "Winding:=", _
  "PhaseC")
...
oModule.AssignCoil Array("NAME:PhB_6", "Objects:=", Array("Coil_6"), _
  "Conductor number:=", 15, "PolarityType:=", "Positive", "Winding:=", _
  "PhaseB")
oModule.AssignCoil Array("NAME:PhBRe_6", "Objects:=", Array("CoilRe_15"), _
  "Conductor number:=", 15, "PolarityType:=", "Negative", "Winding:=", _
  "PhaseB")
...
oModule.AssignCoil Array("NAME:PhBRe_17", "Objects:=", Array("Coil_17"), _
  "Conductor number:=", 15, "PolarityType:=", "Negative", "Winding:=", _
  "PhaseB")
oModule.AssignCoil Array("NAME:PhA_27", "Objects:=", Array("CoilRe_0"), _
  "Conductor number:=", 15, "PolarityType:=", "Positive", "Winding:=", _
  "PhaseA")
oModule.AssignCoil Array("NAME:PhA_28", "Objects:=", Array("CoilRe_1"), _
  "Conductor number:=", 15, "PolarityType:=", "Positive", "Winding:=", _
  "PhaseA")
oModule.AssignCoil Array("NAME:PhA_29", "Objects:=", Array("CoilRe_2"), _
  "Conductor number:=", 15, "PolarityType:=", "Positive", "Winding:=", _
  "PhaseA")
oModule.AssignCoil Array("NAME:PhCRe_30", "Objects:=", Array("CoilRe_3"), _
  "Conductor number:=", 15, "PolarityType:=", "Negative", "Winding:=", _
  "PhaseC")
oModule.AssignCoil Array("NAME:PhCRe_31", "Objects:=", Array("CoilRe_4"), _
  "Conductor number:=", 15, "PolarityType:=", "Negative", "Winding:=", _
  "PhaseC")
oModule.AssignCoil Array("NAME:PhCRe_32", "Objects:=", Array("CoilRe_5"), _
  "Conductor number:=", 15, "PolarityType:=", "Negative", "Winding:=", _
  "PhaseC")
oModule.AssignCoil Array("NAME:PhB_33", "Objects:=", Array("CoilRe_6"), _
  "Conductor number:=", 15, "PolarityType:=", "Positive", "Winding:=", _
  "PhaseB")
oModule.AssignCoil Array("NAME:PhB_34", "Objects:=", Array("CoilRe_7"), _
  "Conductor number:=", 15, "PolarityType:=", "Positive", "Winding:=", _
  "PhaseB")
oModule.AssignCoil Array("NAME:PhB_35", "Objects:=", Array("CoilRe_8"), _
  "Conductor number:=", 15, "PolarityType:=", "Positive", "Winding:=", _
  "PhaseB")
...
oModule.AssignLengthOp Array("NAME:Length_Coil", "RefineInside:=", true, _
  ...
  "RestrictLength:=", true, "MaxLength:=", "1.8175mm")
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/SlotCore", "Version:=", "12.1", "NoOfParameters:=", 19, _
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
...
oModule.AssignEndConnection Array("NAME:EndConnection1", "Objects:=", Array(_
  ...
  "Bar_Separate13", "Bar_Separate14"), "ResistanceValue:=", "4.07853e-006ohm", _
  "InductanceValue:=", "1.42064e-008H")
Set oModule = oDesign.GetModule("MeshSetup")
...
oModule.AssignTrueSurfOp Array("NAME:SurfApprox_Bar", "Objects:=", Array("Bar", _
  ...
  "0.02735mm", "NormalDevChoice:=", 2, "NormalDev:=", "15deg", _
  "AspectRatioChoice:=", 1)
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/SlotCore", "Version:=", "12.1", "NoOfParameters:=", 19, _
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
...
oModule.AssignLengthOp Array("NAME:Length_Main", "RefineInside:=", true, _
  ...
  "RestrictLength:=", true, "MaxLength:=", "3.53mm")
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
