...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Name:=", "DiaGap", "Value:=", "54.85mm"), Array("NAME:Pair", "Name:=", _
  "DiaYoke", "Value:=", "18mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "423.019079116546mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "DiaYoke", "Value:=", "90mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "350mm"), Array("NAME:Pair", "Name:=", "Skew", "Value:=", "0deg"), _
  ...
  "Value:=", "423.019079116546mm"), Array("NAME:Pair", "Name:=", "InfoCore", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "423.019079116546mm"), Array("NAME:Pair", "Name:=", "InfoCoil", "Value:=", _
...
oModule.AssignWindingGroup Array("NAME:PhaseA", "Type:=", "Voltage", _
  "IsSolid:=", false, "Current:=", "0A", "Resistance:=", "14.9043ohm", _
...
oModule.AssignCoilTerminal Array("NAME:PhA_0", "Objects:=", Array("CoilTerm_0"), _
  "Conductor number:=", 11, "Point out of terminal:=", false, "Winding:=", _
  "PhaseA")
...
oModule.AssignCoilTerminal Array("NAME:PhCRe_3", "Objects:=", Array(_
  "CoilTerm_3"), "Conductor number:=", 11, "Point out of terminal:=", true, _
  "Winding:=", "PhaseC")
oModule.AssignCoilTerminal Array("NAME:PhCRe_4", "Objects:=", Array(_
  "CoilTerm_4"), "Conductor number:=", 11, "Point out of terminal:=", true, _
  "Winding:=", "PhaseC")
oModule.AssignCoilTerminal Array("NAME:PhCRe_5", "Objects:=", Array(_
  "CoilTerm_5"), "Conductor number:=", 11, "Point out of terminal:=", true, _
  "Winding:=", "PhaseC")
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/SlotCore", "Version:=", "12.1", "NoOfParameters:=", 19, _
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
  "Name:=", "DiaGap", "Value:=", "54.7mm"), Array("NAME:Pair", "Name:=", _
  "DiaYoke", "Value:=", "18mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "350mm"), Array("NAME:Pair", "Name:=", "Skew", "Value:=", _
  ...
  "Name:=", "LenRegion", "Value:=", "423.019079116546mm"), Array("NAME:Pair", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  Array("NAME:Pair", "Name:=", "DiaGap", "Value:=", "54.7mm"), Array(_
  "NAME:Pair", "Name:=", "DiaYoke", "Value:=", "18mm"), Array("NAME:Pair", _
  "Name:=", "Length", "Value:=", "350mm"), Array("NAME:Pair", "Name:=", _
  ...
  "Name:=", "BarEndExt", "Value:=", "5mm"), Array("NAME:Pair", "Name:=", _
...
oModule.AssignLengthOp Array("NAME:Length_Main", "RefineInside:=", true, _
  ...
  "RestrictLength:=", true, "MaxLength:=", "14.12mm")
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "Consider Mechanical Transient:=", true, "Angular Velocity:=", "1467.11rpm", _
  "Moment of Inertia:=", 0.00239945, "Damping:=", 0.00142036, "Load Torque:=", _
  "if(speed<141.372, -0.05504*speed, -1100.03/speed)", "Objects:=", Array(_
  "Band"))
