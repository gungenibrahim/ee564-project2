...
oModule.AssignWindingGroup Array("NAME:PhaseA", "Type:=", "Voltage", _
  ...
  "Inductance:=", "0.000604126H", "Voltage:=", "310.269 * sin(2*pi*50*time)", _
  "ParallelBranchesNum:=", "1")
Set oModule = oDesign.GetModule("BoundarySetup")
oModule.AssignWindingGroup Array("NAME:PhaseB", "Type:=", "Voltage", _
  "IsSolid:=", false, "Current:=", "0A", "Resistance:=", "14.9043ohm", _
  "Inductance:=", "0.000604126H", "Voltage:=", _
...
oModule.AssignCoil Array("NAME:PhA_0", "Objects:=", Array("Coil_0"), _
  "Conductor number:=", 11, "PolarityType:=", "Positive", "Winding:=", _
  "PhaseA")
oModule.AssignCoil Array("NAME:PhARe_0", "Objects:=", Array("CoilRe_7"), _
  "Conductor number:=", 11, "PolarityType:=", "Negative", "Winding:=", _
  "PhaseA")
...
oModule.AssignEndConnection Array("NAME:EndConnection1", "Objects:=", Array(_
  ...
  "Bar_Separate13", "Bar_Separate14"), "ResistanceValue:=", "4.07838e-006ohm", _
  "InductanceValue:=", "1.40932e-008H")
Set oModule = oDesign.GetModule("MeshSetup")
